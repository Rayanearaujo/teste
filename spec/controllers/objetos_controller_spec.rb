...
RSpec.describe ObjetosController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested objeto as @objeto" do
      objeto = Objeto.create! valid_attributes
      get :show, {:id => objeto.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested objeto as @objeto" do
      objeto = Objeto.create! valid_attributes
      get :edit, {:id => objeto.to_param}, valid_session
      expect(assigns(:objeto)).to eq(objeto)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Objeto" do
        expect {
          post :create, {:objeto => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved objeto as @objeto" do
        post :create, {:objeto => invalid_attributes}, valid_session
        expect(assigns(:objeto)).to be_a_new(Objeto)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested objeto" do
        objeto = Objeto.create! valid_attributes
        put :update, {:id => objeto.to_param, :objeto => new_attributes}, valid_session
        objeto.reload
      ...
      it "assigns the requested objeto as @objeto" do
        objeto = Objeto.create! valid_attributes
        put :update, {:id => objeto.to_param, :objeto => valid_attributes}, valid_session
        expect(assigns(:objeto)).to eq(objeto)
      end
    ...
    describe "with invalid params" do
      it "assigns the objeto as @objeto" do
        objeto = Objeto.create! valid_attributes
        put :update, {:id => objeto.to_param, :objeto => invalid_attributes}, valid_session
        expect(assigns(:objeto)).to eq(objeto)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested objeto" do
      objeto = Objeto.create! valid_attributes
      expect {
        delete :destroy, {:id => objeto.to_param}, valid_session
      }.to change(Objeto, :count).by(-1)
    end
